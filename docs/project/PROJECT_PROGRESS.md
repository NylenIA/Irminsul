...
| Intégration moteur | 15 | 12 | 88 | high | Stats finales LIVE (sidecar character_final_stats -> charstats, adapter final-stats/1.0, /characters/[id] avec breakdown/provenance/confiance) + apercu + reactions ; parite prouvee ; verrou phase3 leve ; ADDITIVES dans l'UI (aggravate/spread cables via flatBaseDamage, le coup affiche est l'aggrave reel) + lunaires LC/LCrys selectionnables | sidecar par defaut |
