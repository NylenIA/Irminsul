...
| Design system et UX | 5 | 5 | 74 | medium | tokens OKLCH + primitives + effets astral reduced-motion safe ; SELECT (chevron tokens, 10 selects bruts migres sur 5 ecrans, axe 0 critique) ; TOAST (aria-live polite, variantes, auto-dismiss, cable app-wide + Team Lab avec preuve E2E) | Tabs/CharacterPicker ; brand guide |
