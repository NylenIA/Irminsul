...
| Application web | 15 | 10 | 25 | high | Next.js 16.2.9 build OK, shell honnete sans donnee factice | vertical slice, design system |
...
| Team builder et simulation | 15 | 15 | 25 | medium | team_optimizer Python deterministe existe ; gcsim partiel | aucune UI team builder ; wiring + validation E2E |
| Persistance | 5 | 8 | 50 | medium | Prisma 6 + SQLite local ; interface TeamRepository ; test repository (Vitest) | wiring UI ; presets/builds |
| Design system et UX | 5 | 5 | 25 | medium | skill frontend-design installe ; direction 'Archive astrale' definie | packages/ui (tokens OKLCH + composants) a construire |
