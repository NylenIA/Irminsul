...
| Team builder et simulation | 15 | 15 | 93 | medium | Team Lab CRUD + reactions + rotations + comparateur + recommandations ; PAGE /simulation : vraies simulations gcsim (E2E reelle) + SQUELETTE gcsim depuis equipe ENRICHI du scan GOOD reel (perso lvl/cons/talents, arme, sets pre-remplis ; substats+rotation en TODO honnete ; toast N/M builds) ; fonction pure testee (104 vitest) | substats reels dans le squelette (via character_final_stats) ; energie/cooldown ; buffs par action |
