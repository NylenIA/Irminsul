...
|---|--:|--:|--:|---|---|---|
| Moteur de données et calcul | 25 | 30 | 85 | high | Moteur stats finales INTEGRE (basestats+weaponstats+talentstats+charstats, defensif) ; pytest 231 ; goldens vs jeu ; registre mecaniques verified ; Lunar-Charged LIVRE bout-en-bout (formule KQM sourcee, EM 6x/(x+2000) resolu sur points publies, agregation 1/0.5/1/12/1/12, sidecar+miroir TS goldens croises+UI apercu, E2E 48) | Lunar-Bloom/Crystallize (multiplicateurs non confirmes -> exclus volontairement) ; gcsim nouveaux persos |
