...
| Team builder et simulation | 15 | 15 | 92 | medium | Team Lab CRUD + reactions + rotations + comparateur + recommandations ; PAGE /simulation : vraies simulations gcsim (IPC run_gcsim sanitize, E2E reelle) + SQUELETTE gcsim genere depuis une equipe sauvegardee (teamToGcsimSkeleton, cles best-effort annotees, TODO honnetes, aucune valeur inventee, E2E) | auto-remplissage armes/stats du squelette depuis un scan GOOD ; energie/cooldown ; buffs par action |
